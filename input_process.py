...
#num_segments, input_size = mfcc_features.shape[0], mfcc_features.shape[1]
#desired_input_size = 880  # Desired input size
#mfcc_features = mfcc_features[:, :desired_input_size]  # Trim the features to the desired size
