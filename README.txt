...
## AIST2010_Project - Predicting Singers from Songs through Machine Learning

### Package Requirements
Please refer to the `requirements.txt` file for the necessary packages.

### Dataset Preparation
1. Download the dataset directory from the following link: [Dataset Link]
...
1. Run the `get_mfcc.py` script to generate the MFCC (Mel-frequency cepstral coefficients) data.
   - Alternatively, you can download the pre-generated MFCC data from this link: 
   [MFCC Data](https://mycuhk-my.sharepoint.com/:x:/g/personal/1155158772_link_cuhk_edu_hk/EXTtCtUrgFFPqLltYS3saE8BBROPPZyGFp-NRz1ZWuRBSQ?e=FYoahq)
...
**Note**: Due to limitations of the live server, it is recommended to run the front-end (HTML) and back-end (api.py) in separate windows of VSCode. 
If you encounter any issues with webpage refreshing, you can refer to the following Stack Overflow thread for potential solutions: [Preventing Page Refreshing]
